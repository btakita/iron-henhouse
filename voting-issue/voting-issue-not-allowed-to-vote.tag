  ...
  <article id="main">
    ...
    <section class="wrapper style5">
      <div class="inner">
        ...
        <a class="still-have-issues" href="#not-eighteen">I am not 18 years of age as of June 7th, 2016.</a>
        <div id="not-eighteen">
        ...
        <a class="still-have-issues" href="#felon">I am a convicted felon currently on parole or imprisoned.</a>
        <div id="felon">
          <p>DAww, shucks. Looks like you are not eligible to vote today. But you can still make a difference by encouraging eligible friends and family to head to the polls!</p>
        </div>
        <a class="still-have-issues" href="#late">I entered the line to vote at my polling site after 8pm PST on Election Day.</a>
        <div id="late">
