  ...
  <article id="main">
    ...
    <section class="wrapper style5">
      <div class="inner">
        ...
        <a class="still-have-issues" href="#not-assigned-precinct">I’m not at my assigned precinct.</a>
        <div id="not-assigned-precinct">
          ...
          <a class="get-email" href="#not-assigned-precinct-send-email-yes">Yes</a>
          <form id="not-assigned-precinct-send-email-yes" action="">
            <label for=""><input type="text">Enter Your Email</label>
            <button type="submit">Submit</button>
          </form>
          <a class="get-email-no" href="#not-assigned-precinct-send-email-no">No</a>
          <div id="not-assigned-precinct-send-email-no">
        ...
        <a class="still-have-issues" href="#vote-by-mail">I’m listed as Vote-By-Mail (VBM) but I did not bring my Vote-By-Mail ballot to surrender at the polling place.</a>
        <div id="vote-by-mail">
          ...
          <h2 class="issue-heading">Would you like to have the link emailed to you to check the status after today?</h2>
          <a class="get-email" href="#vote-by-mail-send-email-yes">Yes</a>
          <form id="vote-by-mail-send-email-yes" action="">
            <label for=""><input type="text">Enter Your Email</label>
            <button type="submit">Submit</button>
          </form>
          <a class="get-email-no" href="#vote-by-mail-send-email-no">No</a>
          <div id="vote-by-mail-send-email-no">
            <p>No problem! We hope this helped. Any more questions can be sent directly to <a href="mailto:cavoterprotection@berniesanders.com">cavoterprotection@berniesanders.com</a>.</p>
          </div>
        </div>


        <a class="still-have-issues" href="#another-party-preference">I’m listed as another party preference and not as Democrat. </a>
        <div id="another-party-preference">
          ...
          <h2 class="issue-heading">Would you like to have the link emailed to you to check the status after today?</h2>
          <a class="get-email" href="#another-party-preference-send-email-yes">Yes</a>
          <form id="another-party-preference-send-email-yes" action="">
            <label for=""><input type="text">Enter Your Email</label>
            <button type="submit">Submit</button>
          </form>
          <a class="get-email-no" href="#another-party-preference-send-email-no">No</a>
          <div id="another-party-preference-send-email-no">
            <p>No problem! We hope this helped. Any more questions can be sent directly to <a href="mailto:cavoterprotection@berniesanders.com">cavoterprotection@berniesanders.com</a>.</p>
          </div>
        </div>

        <a class="still-have-issues" href="#first-time-voting">This is my first time voting.</a>
        <div id="first-time-voting">
          ...
          <ul>
            ...
            <li>
              ...
              <a class="great-i-was-able-to-vote" href="#great-i-got-democratic-ballot">Great! I was able to provide ID and vote on a Democratic Ballot.</a>
              ...
              <div id="unable-to-give-id">
                ...
                <h2 class="issue-heading">Would you like to have the link emailed to you to check the status after today?</h2>
                <a class="get-email" href="#unable-to-give-id-send-email-yes">Yes</a>
                <form id="unable-to-give-id-send-email-yes" action="">
                  <label for=""><input type="text">Enter Your Email</label>
                  <button type="submit">Submit</button>
                </form>
                <a class="get-email-no" href="#unable-to-give-id-send-email-no">No</a>
                <div id="unable-to-give-id-send-email-no">
                  <p>No problem! We hope this helped. Any more questions can be sent directly to <a href="mailto:cavoterprotection@berniesanders.com">cavoterprotection@berniesanders.com</a>.</p>
                </div>
              </div>
            </li>
        ...
        <a class="still-have-issues" href="#moved">I moved within my county but did not re-register to vote. </a>
        <div id="moved">
          ...
          <h2 class="issue-heading">Would you like to have the link emailed to you to check the status after today?</h2>
          <a class="get-email" href="#moved-send-email-yes">Yes</a>
          <form id="moved-send-email-yes" action="">
            <label for=""><input type="text">Enter Your Email</label>
            <button type="submit">Submit</button>
          </form>
          <a class="get-email-no" href="#moved-send-email-no">No</a>
          <div id="moved-send-email-no">
            <p>No problem! We hope this helped. Any more questions can be sent directly to <a href="mailto:cavoterprotection@berniesanders.com">cavoterprotection@berniesanders.com</a>.</p>
          </div>
        </div>


        <a class="still-have-issues" href="#none-apply">None of these reasons apply to me.</a>
        <div id="none-apply">
          <h2 class="issue-heading">Okay. What is the reason they are giving you a provisional ballot?</h2>
          <a class="still-have-issues" href="#name-not-on-poll-list">My name is not on the poll list.</a>
          <div id="name-not-on-poll-list">
            ...
            <a class="still-have-issues" href="#registered-to-vote">Yes, I’m registered to vote in this precinct.</a>
            <div id="registered-to-vote">
              <p>
              ...
              <a class="great-i-was-able-to-vote" href="#great-found-my-name">They found my name.</a>
              <div id="great-found-my-name">
              ...
              <a class="great-i-was-able-to-vote" href="#great-found-my-name2">They found my name.</a>
              <div id="great-found-my-name2">
                <p class="success-text">Great! All you have to do is verify your name and address and your name will be put back into the active list and you should be given a regular ballot (not a provisional one). (EC § 2226.)</p>
                <a class="still-have-issues" href="#not-on-inactive-list">My name is not on the inactive list. </a>
                <div id="not-on-inactive-list">
                  ...
                  <h2 class="issue-heading">Would you like to have the link emailed to you to check the status after today?</h2>
                  <a class="get-email" href="#not-on-inactive-list-send-email-yes">Yes</a>
                  <form id="not-on-inactive-list-send-email-yes" action="">
                    <label for=""><input type="text">Enter Your Email</label>
                    <button type="submit">Submit</button>
                  </form>
                  <a class="get-email-no" href="#not-on-inactive-list-send-email-no">No</a>
                  <div id="not-on-inactive-list-send-email-no">
                    <p>No problem! We hope this helped. Any more questions can be sent directly to <a href="mailto:cavoterprotection@berniesanders.com">cavoterprotection@berniesanders.com</a>.</p>
                  </div>
                </div>
              </div>
        ...
        <a class="still-have-issues" href="#no-party-preference">I’m registered as No Party Preference (“NPP")</a>
        <div id="moved">
          ...
          <a class="great-i-was-able-to-vote" href="#great-no-party-preference">Great, I was able to vote!</a>
          <div id="great-no-party-preference">
