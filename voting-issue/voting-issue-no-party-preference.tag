  ...
  <article id="main">
    ...
    <section class="wrapper style5">
      <div class="inner">
        ...
        <a class="great-i-was-able-to-vote" href="#great-i-got-democratic-ballot">Great, I was able to vote!</a>
        <div id="great-i-got-democratic-ballot">
          <p class="success-text">Yay!  Glad we could help</p>
        </div>
        <a class="still-have-issues" href="#i-am-not-given-democratic-ballot">I am not being given the requested “Democratic Ballot” or “Crossover Democratic Ballot”.</a>
